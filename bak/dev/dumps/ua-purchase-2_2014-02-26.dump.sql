...
-- Exported: 9:09pm on February 26, 2014 (CET)
...
CREATE TABLE 'firm' (
  ...
  'addressID' INTEGER DEFAULT NULL REFERENCES address(addressID) ON DELETE SET NULL ON UPDATE CASCADE,
  'name' TEXT NOT NULL,
  'website' TEXT NOT NULL
);
CREATE TABLE 'contact' (
  'contactID' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
  'firmID' INTEGER NOT NULL REFERENCES firm(firmID) ON UPDATE CASCADE ON DELETE CASCADE,
  'addressID' INTEGER DEFAULT NULL REFERENCES address(addressID) ON UPDATE CASCADE ON DELETE SET NULL,
...
CREATE TABLE 'item' (
  ...
  'parentID' INTEGER DEFAULT NULL REFERENCES item(itemID) ON UPDATE CASCADE ON DELETE CASCADE,
  'templateID' INTEGER REFERENCES template(templateID) ON UPDATE CASCADE ON DELETE RESTRICT,
  'name' TEXT NOT NULL,
  'desc' TEXT NOT NULL,
...
CREATE TABLE 'price' (
  ...
  'reasonID' INTEGER DEFAULT NULL REFERENCES item(itemid) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE 'order' (
  ...
  'contactID' INTEGER DEFAULT NULL REFERENCES contact(contactID) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE "purchase" (
  ...
  'contactID' INTEGER DEFAULT NULL REFERENCES contact(contactID) ON DELETE CASCADE ON UPDATE CASCADE,
  'firmID' INTEGER DEFAULT NULL REFERENCES firm(firmID) ON DELETE CASCADE ON UPDATE CASCADE,
  'itemID' INTEGER NOT NULL REFERENCES item(itemID) ON DELETE CASCADE ON UPDATE CASCADE,
  'orderID' INTEGER DEFAULT NULL REFERENCES "order"(orderID) ON DELETE CASCADE ON UPDATE CASCADE,
  'isMember' BOOLEAN NOT NULL DEFAULT 'false',
  'data' TEXT
);
CREATE TABLE 'discount' (
  'discountID' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
  'itemID' INTEGER DEFAULT NULL REFERENCES item(itemID) ON DELETE CASCADE ON UPDATE CASCADE,
  'name' TEXT NOT NULL,
  'code' TEXT NOT NULL,
...
CREATE TABLE 'tie' (
  ...
  'fieldID' INTEGER NOT NULL REFERENCES field(fieldID) ON DELETE CASCADE ON UPDATE CASCADE,
  'itemID' INTEGER NOT NULL REFERENCES item(itemID) ON DELETE CASCADE ON UPDATE CASCADE,
...
----
INSERT INTO "address" ("addressID","addrName","addr1","addr2","city","state","zip") VALUES ('1','Helena Location','828 Great Northern Boulevard,','','Helena','MT','59624-1040');
INSERT INTO "address" ("addressID","addrName","addr1","addr2","city","state","zip") VALUES ('2','asdf','asdf','asdf','asdf','asdf','asdf');
INSERT INTO "address" ("addressID","addrName","addr1","addr2","city","state","zip") VALUES ('3','Work','P. O. Box 1147','','Helena','MT','59624');
INSERT INTO "address" ("addressID","addrName","addr1","addr2","city","state","zip") VALUES ('4','Billings Office','123','','Billings','MT','59801');
INSERT INTO "address" ("addressID","addrName","addr1","addr2","city","state","zip") VALUES ('5','Helena office','282 ABC','','A','MT','55555');

----
-- Data dump for firm, a total of 3 rows
----
INSERT INTO "firm" ("firmID","addressID","name","website") VALUES ('1','1','Upstream Academy','http://upstreamacademy.com');
INSERT INTO "firm" ("firmID","addressID","name","website") VALUES ('2','2','asdf','http://asdf.asdf');
INSERT INTO "firm" ("firmID","addressID","name","website") VALUES ('3','5','ABC Firm','http://www.ABC.com');

----
-- Data dump for contact, a total of 6 rows
----
INSERT INTO "contact" ("contactID","firmID","addressID","legalName","preName","title","email","phone","pass","resetHash","resetExpires","lastLogin","isAdmin") VALUES ('1','1','1','Nathan J. K. Woods','aq1AQ!','Programmer','nwoods@azworld.com','(406) 890-0603','39b69228e3900a93218eaafd6b1a4ceb495f9d48',NULL,NULL,'2014-02-25 15:35:10','true');
INSERT INTO "contact" ("contactID","firmID","addressID","legalName","preName","title","email","phone","pass","resetHash","resetExpires","lastLogin","isAdmin") VALUES ('2','2','1','asdf','asdf','asdf','nwoods@carroll.edu','(345) 234-1234','Bed5/eZOyfbBg',NULL,NULL,'2014-02-17 13:17:27','false');
INSERT INTO "contact" ("contactID","firmID","addressID","legalName","preName","title","email","phone","pass","resetHash","resetExpires","lastLogin","isAdmin") VALUES ('3','1','1','Georgia','','Director','georgiac@upstreamacademy.com','(406) 495-1850','BeJtVebPqWGbI',NULL,NULL,'2014-02-13 11:09:59','false');
INSERT INTO "contact" ("contactID","firmID","addressID","legalName","preName","title","email","phone","pass","resetHash","resetExpires","lastLogin","isAdmin") VALUES ('4','1','1','Tim Bartz','','Director','timb@upstreamacademy.com','(406) 495-1850',NULL,NULL,NULL,'2014-02-13 11:11:41','false');
INSERT INTO "contact" ("contactID","firmID","addressID","legalName","preName","title","email","phone","pass","resetHash","resetExpires","lastLogin","isAdmin") VALUES ('5','1','4','William B','Bill','Janitor','bill@upstream.com','5',NULL,NULL,NULL,'2014-02-13 11:14:05','false');
INSERT INTO "contact" ("contactID","firmID","addressID","legalName","preName","title","email","phone","pass","resetHash","resetExpires","lastLogin","isAdmin") VALUES ('6','3','5','Henry','Hank','Director','email@email.com','(458) 488-4885','BeJtVebPqWGbI',NULL,NULL,'2014-02-13 11:52:41','false');

----
-- Data dump for template, a total of 4 rows
----
INSERT INTO "template" ("templateID","name","pretty","costReq","itemReq") VALUES ('1','Download','${cost|%01.2f}','cost','file');
INSERT INTO "template" ("templateID","name","pretty","costReq","itemReq") VALUES ('2','Membership','${cost|%01.2f}','cost','');
INSERT INTO "template" ("templateID","name","pretty","costReq","itemReq") VALUES ('3','Hardcopy','${hard|%01.2f} for Hard Copy; ${soft|%01.2f} for Soft Copy','hard,soft','file');
INSERT INTO "template" ("templateID","name","pretty","costReq","itemReq") VALUES ('4','Conference','${initial|%01.2f} for first {after} attendee(s), ${later|%01.2f} for additional','initial,later,after','eventDate');
...
INSERT INTO "item" ("itemID","parentID","templateID","name","desc","settings","code","image","visable","onFirm") VALUES ('7',NULL,NULL,'Management Presentations','','folder',NULL,NULL,'false','true');
...
----
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('1','3',NULL,'{"cost":"875"}','true','2');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('2','4',NULL,'{"cost":"3500"}','true','2');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('3','5',NULL,'{"cost":"2000"}','true','2');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('4','6',NULL,'{"cost":"7000"}','true','2');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('5','8','2','{"soft":"100", "hard":"150"}','true','3');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('6','8',NULL,'{"soft":"195", "hard":"245"}','true','3');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('7','11',NULL,'{"cost":"19.95"}','true','1');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('8','12','2','{"initial":"3050","later":"650","after":"3"}','true','4');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('9','12',NULL,'{"initial":"3500","later":"800","after":"3"}','true','4');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('10','13','2','{"initial":"895","later":"795","after":"1"}','true','4');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('11','13',NULL,'{"initial":"1195","later":"995","after":"1"}','true','4');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('12','14','165','{"cost":"125"}','true','1');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('13','14','2','{"cost":"125"}','true','1');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('14','14',NULL,'{"cost":"200"}','true','1');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('15','15','2','{"initial":"895","later":"795","after":"1"}','true','4');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('16','15',NULL,'{"initial":"1195","later":"995","after":"1"}','true','4');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('17','16','165','{"initial":"2500","later":"2500","after":"1"}','true','4');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('18','16','166','{"initial":"2500","later":"2500","after":"1"}','true','4');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('19','16','167','{"initial":"2700","later":"2700","after":"1"}','true','4');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('20','16','168','{"initial":"2500","later":"2500","after":"1"}','true','4');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('21','16','2','{"initial":"2500","later":"2500","after":"1"}','true','4');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('22','16',NULL,'{"initial":"3000","later":"3000","after":"1"}','true','4');
INSERT INTO "price" ("priceID","itemID","reasonID","settings","inCart","templateID") VALUES ('23','9',NULL,'{"cost":"295"}','true','1');
...
INSERT INTO "field" ("fieldID","name","type","toStore","settings") VALUES ('10','Other Offices (comma separated)','text','yes','');
INSERT INTO "field" ("fieldID","name","type","toStore","settings") VALUES ('11','Professional Affiliations (comma separated)','text','yes','');
INSERT INTO "field" ("fieldID","name","type","toStore","settings") VALUES ('12','Form of Practice','radioboxes','yes','["Partnership","Partnership (LLP)","S Corporation","C Corporation","Company","Other"]');
INSERT INTO "field" ("fieldID","name","type","toStore","settings") VALUES ('13','Total number of Owners','text','yes','"numeric"');
INSERT INTO "field" ("fieldID","name","type","toStore","settings") VALUES ('14','Total number of Professional Staff','text','yes','"numeric"');
INSERT INTO "field" ("fieldID","name","type","toStore","settings") VALUES ('15','Total number of Administrative Personnel','text','yes','"numeric"');
INSERT INTO "field" ("fieldID","name","type","toStore","settings") VALUES ('16','Niche/Specialties','otherCheckbox','yes','["Tax","Audit","Payroll  Services","Business Management Consulting","Fraud Examination","IT Consulting","Business Valuation","Cost Segregation","Controller Services","Litigation Support","Financial Planning","SOX 44 Consulting"]');
INSERT INTO "field" ("fieldID","name","type","toStore","settings") VALUES ('17','How did you hear about Upstream?','text','yes','');
INSERT INTO "field" ("fieldID","name","type","toStore","settings") VALUES ('18','Total number of Personnel','text','yes','"numeric"');
INSERT INTO "field" ("fieldID","name","type","toStore","settings") VALUES ('19','Test Select','otherSelect','yes','["A","B","C","D"]');

----
-- Data dump for order, a total of 7 rows
----
INSERT INTO "order" ("orderID","contactID","status","medium","stamp","amount") VALUES ('1','1','pending','check','2014-02-20 17:45:49','123.45');

----
-- Data dump for purchase, a total of 2 rows
----
INSERT INTO "purchase" ("purchaseID","contactID","firmID","itemID","orderID","isMember","data") VALUES ('1',NULL,'1','167','1','true','manual');
INSERT INTO "purchase" ("purchaseID","contactID","firmID","itemID","orderID","isMember","data") VALUES ('2',NULL,'1','168',NULL,'true','manual');

----
-- Data dump for discount, a total of 3 rows
----
INSERT INTO "discount" ("discountID","itemID","name","code","amount","active","compound") VALUES ('1','11','LeaderSkills Lessons','lsl','15','true','false');
INSERT INTO "discount" ("discountID","itemID","name","code","amount","active","compound") VALUES ('2',NULL,'Xmas','xmas','15','false','false');
INSERT INTO "discount" ("discountID","itemID","name","code","amount","active","compound") VALUES ('3',NULL,'Free Discount','free','50','true','false');

----
-- Data dump for tie, a total of 21 rows
----
INSERT INTO "tie" ("tieID","fieldID","itemID","order","required") VALUES ('1','2','2','1','false');
INSERT INTO "tie" ("tieID","fieldID","itemID","order","required") VALUES ('2','10','2','2','false');
INSERT INTO "tie" ("tieID","fieldID","itemID","order","required") VALUES ('3','11','2','3','false');
INSERT INTO "tie" ("tieID","fieldID","itemID","order","required") VALUES ('4','12','2','4','false');
INSERT INTO "tie" ("tieID","fieldID","itemID","order","required") VALUES ('5','18','2','5','false');
INSERT INTO "tie" ("tieID","fieldID","itemID","order","required") VALUES ('6','13','2','6','false');
INSERT INTO "tie" ("tieID","fieldID","itemID","order","required") VALUES ('7','14','2','7','false');
INSERT INTO "tie" ("tieID","fieldID","itemID","order","required") VALUES ('8','15','2','8','false');
INSERT INTO "tie" ("tieID","fieldID","itemID","order","required") VALUES ('9','16','2','9','false');
INSERT INTO "tie" ("tieID","fieldID","itemID","order","required") VALUES ('10','17','2','10','false');
